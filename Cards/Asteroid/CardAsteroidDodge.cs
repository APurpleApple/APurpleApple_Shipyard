...
{
    internal class CardAsteroidDodge: Card, IModCard
    {
        public static void Register(IModHelper helper)
        {
            ...
            helper.Content.Cards.RegisterCard(type.Name, new()
            {
                ...
                Name = PMod.Instance.AnyLocalizations.Bind(["card", "AsteroidDodge", "name"]).Localize
            });
        }
        ...
        public override List<CardAction> GetActions(State s, Combat c)
        {
            ...
            actions.Add(new AStatus() { status = SStatus.evade, statusAmount = upgrade == Upgrade.B ? 2 : 1, targetPlayer =true, disabled = flipped});
