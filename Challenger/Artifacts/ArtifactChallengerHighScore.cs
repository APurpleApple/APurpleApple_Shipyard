    ...
    public class ArtifactChallengerHighScore : Artifact, IModArtifact
    {
        ...
        public static void Register(IModHelper helper)
        {
            ...
            helper.Content.Artifacts.RegisterArtifact(type.Name, new()
            {
                ...
                Sprite = PMod.sprites[PSpr.Artifacts_HighScore].Sprite,
        ...
        {
            return shouldBeRight.HasValue ? shouldBeRight.Value ? PMod.sprites[PSpr.Artifacts_HighScoreRight].Sprite : PMod.sprites[PSpr.Artifacts_HighScoreLeft].Sprite : PMod.sprites[PSpr.Artifacts_HighScore].Sprite;
        }
    }
}
